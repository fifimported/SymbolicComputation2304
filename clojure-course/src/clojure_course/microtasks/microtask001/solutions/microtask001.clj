...
; there is "print" function that does the same but doesn't add a new line at the end of printed string.
; you may use commas as delimiters but this is optional. Space considered as delimiter as well.
(println "the total number of toes =" (+ 4 4 5 5))
